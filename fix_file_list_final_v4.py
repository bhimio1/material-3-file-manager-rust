    ...
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        div()
            ...
            .child({
                 ...
                 let viewport_width = 1000.0; // Fixed estimate for calc
                     ...
                     if is_grid {
                         ...
                         items_slice
                             ...
                             .map(|(i, item)| {
                                 render_file_item(
                                     item,
                                     i, // This ID might clash with others if not unique scope, but uniform_list handles children
                                     false,
                                     &selection,
                                     &palette,
                                     workspace.clone(),
